"""
Django settings for tst_monkeytestapp__135664 project.
...
ROOT_URLCONF = 'tst_monkeytestapp__135664.urls'
...
WSGI_APPLICATION = 'tst_monkeytestapp__135664.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tst_monkeytestapp__135664 API",
    "DESCRIPTION": "API documentation for tst_monkeytestapp__135664 App",
    "VERSION": "v1",
}
